...
#define AD_SCK          NRF_GPIO_PIN_MAP(0,26)
#define AD_DOUT         NRF_GPIO_PIN_MAP(0,25)
#define SENSOR_PW       NRF_GPIO_PIN_MAP(0,2)
#define CHG_FUL         NRF_GPIO_PIN_MAP(0,5)
#define CHG_DET         NRF_GPIO_PIN_MAP(0,15)
#define LED_GN          NRF_GPIO_PIN_MAP(0,18)
#define LED_RD          NRF_GPIO_PIN_MAP(0,20)
#define POW_BTN         NRF_GPIO_PIN_MAP(0,3)
...
#define AVG_TIMER_INTERVAL APP_TIMER_TICKS(100)
